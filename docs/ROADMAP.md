...
| 2 | **Egzersiz/artefakt döngüsü** | 🔨 yapılıyor (2026-08-15) | Watcher'ı kod dışına genelleme: Usta teslimat atar, kullanıcı `exercises/` altına yazar, aynı feedback döngüsü her domain'de çalışır. |
