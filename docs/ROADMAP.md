...
| # | Özellik | Durum | Özet |
|---|---|---|---|
| 1 | **Görsel anlatım** (`/show`) | spec aşamasında | Gömülü HTML iskelet + model sahne senaryosu üretir → tarayıcıda animasyonlu anlatım. Proaktif öneri: anlaşılmadı sinyalinde Usta `/show` önerir. |
