...
| 9 | **Prompt diet** | 🔨 in progress (2026-08-16) | Principle: anything the shell can solve deterministically never goes into a prompt. Conditional brain loading (GAMIFICATION/MATERIAL/PREDICTION follow the GOAL.md pattern), due-question selection moves to the shell, dead instructions removed. Target v0.19.0. |
...
- 2026-08-16 (in progress → see #9): Prompt diet.
