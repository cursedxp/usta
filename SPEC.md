...
- **Reset confirmations (v0.4, display anglicized v0.20.1):** topic reset `[y/N]`, factory reset a word confirmation (displays "yes"; "evet" silently accepted); closed/empty stdin = no (safe default). Reset commands work without a backend.
