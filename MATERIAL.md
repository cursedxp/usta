...
- The material is the spine, web research the supplement. Map items carry their source ref (`— source: <file> §<section>`).
...
- Scope guarding still applies: critical items the material lacks enter the map from web research, marked `— source: web`.
